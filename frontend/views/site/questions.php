        ...
        <div class="accordion" id="accordionExample" style="margin-top: 2rem">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p>
                            Жауап: Олимипиадалар бойынша ватсапқа жазасыз:
                            <br><a href="https://wa.me/77754037284">https://wa.me/77754037284</a>
        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p>
                            Ответ: Сравните ИИН при регистрации и ИИН при заполнении анкеты.  С  ошибочно указанным  ИИН, Вы не можете принять участие.  Если таковых  расхождений не имеется, то следует проверить, повторно отправив ЧЕК+ИИН  на номер через приложение WhatsApp
            ...
            <div class="accordion-item">
                ...
                <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p>
                            Ответ:  Для исправления ошибок необходимо письменно обратиться  через  приложение  WhatsApp: по номеру
                            <a href="https://wa.me/77013129906">https://wa.me/77013129906</a>  со следующим текстом: «В моем наградном листе допущена ошибка  (в скобках  указать правильный и безошибочный вариант) . Прошу Вас помочь в  решении данного вопроса». Напишите свой  ИИН. Вам будет направлена  ссылка  исправленного варианта наградного листа.
                        </p>
                    </div>
                </div>
            </div>
