            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            ...
                            Чекті және ЖСН-іңізді bilimshini.kz@gmail.com электронды поштасына қатесіз жазып жіберуіңіз міндетті. 24 сағат ішінде Сізге «Тіркелді» деген жауап келеді. Электронды почтаңызға жауап келгеннен кейін ғана олимпиадаға қатысуға мүмкіндік ашылады. Жеке ұялы телефондарда, вадсапта мәселелер қарастырылмайды.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p>
                                Жауап:  Аппеляциялық шағымдар олимпиаданың соңғы күні 15–шы желтоқсан bilimshini.kz@gmail.com электронды поштасында қабылданады. Қарауға 1күн  (жұмыс күні) уақыт қойылған.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p>
                                Ответ:  Если у Вас возникли проблемы с оплатой на сайте: переведите 2000 (две тысячи) тенге на Каспи голд 7 775 403 7284 Жанна, далее Вам необходимо без ошибок отправить ИИН участника и чек на электронную почту bilimshini.kz@gmail.com. В течение 24 часов по электронной почте   вы получите ответ о том, что вы «Зарегистрированы». Только после получения ответа на свою электронную почту о регистрации, Вы сможете принять участие в олимпиаде. По личным мобильным телефонам и по ватсапу вопросы не рассматриваются.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p>
                                Ответ:  Апелляции принимаются в последний день олимпиады 15–го декабря по электронной почте bilimshini.kz@gmail.com. На рассмотрение апелляции берется 1 день.
                            </p>
                        </div>
                    </div>
                </div>
