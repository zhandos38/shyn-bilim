...
<div>
    <div class="cert-page" style="background-image: url('/img/cert.jpg'); background-size: cover; background-repeat: no-repeat; width: 1400px; height: 1200px; font-family: 'Times New Roman';">
        <div id="cert-name" style="padding-top: 400px; padding-left: 400px; width: 760px; text-align: center; font-size: 32px; font-weight: bold; color: #ab7f36;"><?= $model->surname . ' ' . $model->name . ' ' . $model->patronymic ?></div>
        <div id="cert-school" style="padding-top: 5px; padding-left: 400px; font-size: 18px; color: #000000; height: 20px; width: 760px; text-align: center"><?= $model->school->name ?></div>
