...
$qrCode = (new QrCode(\yii\helpers\Url::toRoute(['article/charter', 'id' => $model->id], 'https')))
    ...
    ->setMargin(5);
?>
<div class="cert-page" style="background-image: url('/img/article/ybyrai/2024/charter.jpg'); background-size: cover; background-repeat: no-repeat; width: 1400px; height: 1200px; font-family: 'Times New Roman';">
    <div id="cert-name" style="height: 200px; padding-top: 480px; padding-left: 100px; width: 660px; text-align: center; text-transform: uppercase; line-height: 160%">
    ...
    <div style="padding-top: 260px; padding-left: 110px; font-size: 12px; color: black">
