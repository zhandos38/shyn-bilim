...
<div>
    <div class="cert-page" style="background-image: url('/img/marathon-2022/marathon-certificate-2022.jpg'); background-size: cover; background-repeat: no-repeat; font-family: 'Times New Roman'; height: 1200px">
        <div style="padding-top: 220px; padding-left: 400px; text-align: center; width: 520px; text-align: center;">
        ...
        <div id="footer" style="padding-top: 205px; padding-left: 600px; font-size: 16px; color: #454545; font-family: 'Times New Roman'">
