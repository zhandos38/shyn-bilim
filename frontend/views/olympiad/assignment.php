        ...
        <div class="mb--40">
            ...
            <div>
                ...
                <div style="color: red; font-size: 20px">
                    !! Төлем жасаған соң, тест тапсыруға <b>1 сағаттан соң 2-ші қадамға өтіңіз</b>. <br> Экранда шыққан QR-код арқылы 600 теңге төлеңіз. Kaspi-де QR ашылған кезде жоғарыдағы  «Білім шыңы, Шымкент» деген мәліметті өзгертпеңіз.
                </div>
                <div>
                    <div>
