...
<div class="text-center">
    «ALTYN QYRAN– ерекше дарын иесі» зияткерлік білім сайысына қош келдің! <br>
Олимпиадаға қатысу үшін анкетаны толтыру қажет. Олимпиадаға қатысу жарнасы 500 теңге Мәліметтерді жібере отырып, қоғамдық ұсыныспен келісесіз.
</div>
<div class="row">
    <div class="col-md-4">
        <div>
