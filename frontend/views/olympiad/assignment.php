...
<div class="bg-gradient-13 pt--60 pb--60">
    <div class="container">
        ...
        <h3>
            2-ші қадам. Төлем жасаған соң, тест тапсыруға 1 сағаттан соң қайта кіріңіз сайтқа. Экранда шыққан QR-код арқылы 600 теңге төлеңіз. Kaspi-де QR ашылған кезде жоғарыдағы  «Білім шыңы, Шымкент» деген мәліметті өзгертпеңіз.
        </h3>
