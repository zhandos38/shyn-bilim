...
<div>
    <div class="cert-page" style="background-image: url('/img/ped-olymp-cert.jpg'); background-size: cover; background-repeat: no-repeat; width: 1400px; height: 1200px; font-family: 'Times New Roman';">
        ...
        <div id="cert-school" style="padding-top: 5px; padding-left: 400px; font-size: 16px; color: #000000; height: 74px; width: 900px; text-align: center; font-weight: 200"><?= $testAssignment->kinder_garden ?></div>
        <?php endif; ?>
