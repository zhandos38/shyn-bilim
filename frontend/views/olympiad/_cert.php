...
<div>
    <div class="cert-page" style="background-image: url('/img/altyn-urpak-cert.jpg'); background-size: cover; background-repeat: no-repeat; font-family: 'Times New Roman';">
        ...
        <div style="padding-top: 5px; padding-left: 450px; height: 80px; width: 600px; text-align: center; font-size: 18px; font-weight: bold; text-transform: uppercase">
            <div id="cert-name" style=""><?= ' ' . $testAssignment->leader_name ?></div>
            <div id="cert-name" style=""><?= ' ' . $testAssignment->leader_name_second ?></div>
        </div>
        <div id="footer" style="padding-top: 0; padding-left: 464px; font-size: 16px; color: #454545; font-family: 'Times New Roman'">
            <div id="cert-qrcode" style="height: 60px; padding-top: 40px; padding-left: 560px; width: 160px; font-size: 22px; font-weight: bold;"><img src="<?= $qrCode->writeDataUri() ?>"></div>
            <div id="cert-number" style="padding-bottom: 38px; padding-top: -60px"><?= $testAssignment->id ?></div>
        </div>
    </div>
</div>
