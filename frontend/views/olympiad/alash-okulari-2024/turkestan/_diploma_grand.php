...
?>
<div>
    <div class="cert-page" style="background-image: url('./img/alash-okulari-2024/turkestan/diploma_grand.jpg'); background-size: cover; background-repeat: no-repeat; font-family: 'Arial'; height: 1200px">
        <div style="padding-left: 80px; padding-top: 265px; width: 500px; height: 320px; font-size: 16px; font-weight: 500">
            <div style="text-align: right; font-size: 28px; margin-top: 8px; color: #FE8A1D; padding-right: -90px; text-transform: uppercase">
                <b><?= $place ?></b>
            </div>
        ...
        <div class="border" style="padding-left: 40px; padding-top: 225px">
            ...
            <div style="font-size: 12px; margin-top: 5px">
                ...
                <div style="color: #0a0a0a;">Түркістан, 2024/25 оқу жылдары</div>
            </div>
        </div>
    </div>
</div>
