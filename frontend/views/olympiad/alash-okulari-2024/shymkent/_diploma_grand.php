...
?>
<div>
    <div class="cert-page" style="background-image: url('./img/alash-okulari-2024/shymkent/diploma_grand.jpg'); background-size: cover; background-repeat: no-repeat; font-family: 'Arial'; height: 1200px">
        <div style="padding-left: 80px; padding-top: 265px; width: 570px; height: 320px; font-size: 16px; text-transform: uppercase; font-weight: 500">
            <div style="text-align: right; font-size: 28px; margin-top: 8px; color: #FE8A1D; padding-right: -25px">
                <b><?= $place ?></b>
            </div>
            <div style="padding-top: 200px; height: 100px">
        ...
        <div class="border" style="padding-left: 40px; padding-top: 220px">
