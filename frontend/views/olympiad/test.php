...
<div id="test" class="pb--60 pt--60">
    <div class="container test-app__container">
        ...
        <div v-else>
            ...
            <div class="mt--20">
                <small>
                    Қатысушылар жинаған балдарына сәйкес сертификаттар алады, ал жоғары балл жинаған оқушыларға Бас жүлде және І, ІІ, ІІ дәрежелі дипломдар беріледі. Дипломдар мен сертификаттарды жүктеу ақылы түрде,  жарнасы - 500 тг. (ата-анасының немесе демеушілердің рұқсатымен). Астынғы батырманы басу арқылы толем картасы арқылы немесе
                    <a href="https://pay.kaspi.kz/pay/lzlvssh5" style="color: blue">https://pay.kaspi.kz/pay/lzlvssh5</a> номеріне төлем жасап, төлем чекті, толық аты-жөнің, қатысқан пәніңізді жазып,  және қатысушы оқушының ЖСН-н (қатесіз ЖСН жазыңыз) 8775 424 37 27 WhatsApp номеріне  жіберуіге болады. WhatsApp бойынша төлемді тіркеу туралы жауап алғаннан кейін сіз сайттың басты бетінен «КӨМЕК» деген жерден, дипломыңызды немесе сертификатыңызды жүктей аласыз.
                </small>
            </div>
            <div class="mt--10">
