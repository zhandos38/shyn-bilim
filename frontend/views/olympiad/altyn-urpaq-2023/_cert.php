...
?>
<div>
    <div class="cert-page" style="background-image: url('./img/altyn-urpaq-2023/cert_1-4.jpg'); background-size: cover; background-repeat: no-repeat; font-family: 'Arial'; height: 1200px">
