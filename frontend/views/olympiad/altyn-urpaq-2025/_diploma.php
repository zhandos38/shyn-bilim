...
if ($olympiadId === 24 && $cityId === 3) {
    $template = "shymkent/diploma.jpg";
} else if ($olympiadId === 24 && $regionId === 14) {
    $template = "turkestan/diploma.jpg";
}
?>
<div>
    <div class="cert-page" style="background-image: url(<?= "./img/altyn-urpaq-2025/$template" ?>); background-size: cover; background-repeat: no-repeat; font-family: 'Arial'; height: 1200px">
        <div style="padding-left: 410px; padding-top: 148px; text-align: center; width: 600px; height: 320px; font-size: 16px; text-transform: uppercase; font-weight: 500">
            <div style="font-size: 28px; margin-top: 8px; color: white">
                <b><?= $place ?></b>
            </div>
            <div style="padding-top: 150px; padding-left: 90px; height: 80px; width: 420px; font-size: 14px; text-transform: none">
        ...
        <div class="border" style="padding-left: 125px; padding-top: 80px; color: #fff9f6">
