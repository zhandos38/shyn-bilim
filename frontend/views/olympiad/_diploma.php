...
<div>
    <div class="cert-page" style="background-image: url('/img/diploma-altyn-qyran.jpg'); background-size: cover; background-repeat: no-repeat;font-size: 18px; font-family: 'Times New Roman';">
        <div id="cert-qrcode" style="padding-top: 50px; padding-left: 5px; width: 160px; text-align: center; font-size: 20px; font-weight: bold; "><?= '<img src="' . $qrCode->writeDataUri() . '">' ?></div>
        <div id="cert-region" style="padding-top: 0; padding-left: 770px; height: 45px; width: 200px; text-align: center;">
            <?php
