...
<div>
    <div class="cert-page" style="background-image: url('/img/altyn-urpak-diplom.jpg'); background-size: cover; background-repeat: no-repeat;font-size: 18px; font-family: 'Arial';">
        ...
        <div class="border" style="padding-top: 212px; padding-left: 45px; width: 620px; height: 600px;">
            ...
            <div id="cert-region" style="padding-top: 5px">
                <?php
            ...
            <div id="cert-school"><?= $testAssignment->school->name ?></div>
            <div id="cert-grade"><?= $testAssignment->getGrade() ?></div>
            <div id="cert-name" style="padding-top: 42px; font-size: 22px; font-weight: bold; text-transform: uppercase;"><?= $testAssignment->leader_name ?></div>
            <div id="cert-name" style="padding-top: 12px; font-size: 22px; font-weight: bold; text-transform: uppercase"><?= $testAssignment->leader_name ?></div>
            <div id="cert-qrcode" style="padding-top: 78px; padding-left: 5px; font-size: 22px; font-weight: bold; "><?= '<img src="' . $qrCode->writeDataUri() . '">' ?></div>
