...
<div>
    <div class="cert-page" style="background-image: url('/img/diploma-altyn-qyran.jpg'); background-size: cover; background-repeat: no-repeat;font-size: 18px; font-family: 'Times New Roman';">
        ...
        <div id="cert-region" style="padding-top: 0; padding-left: 770px; height: 20px; width: 200px; text-align: center;">
            <?php
        ...
        <div id="cert-school" style="padding-top: 5px; padding-left: 680px; width: 360px; height: 67px; text-align: center; font-size: 14px;"><?= $testAssignment->school->name ?></div>
