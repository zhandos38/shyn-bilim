...
<div>
    <div class="cert-page" style="background-image: url('./img/altyn-qyran-2024/diploma.jpg'); background-size: cover; background-repeat: no-repeat; font-family: 'Arial'; height: 1200px">
        ...
        <div style="padding-left: 120px; padding-top: 130px; text-align: center; width: 600px; height: 150px; font-size: 20px">
            ...
            <div style="padding-left: 100px; font-family: 'Arial'; height: 100px; width: 400px; font-size: 16px">
