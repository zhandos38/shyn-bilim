...
use backend\models\ArticleWhiteListSearch;
 ...
 */
class ArticleWhiteListController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new ArticleWhiteListSearch();
    ...
    {
        if (($model = ArticleWhiteList::findOne($id)) !== null) {
            return $model;
        }
