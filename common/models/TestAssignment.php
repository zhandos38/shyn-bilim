...
//            ['iin', 'unique', 'targetClass' => '\common\models\TestAssignment', 'message' => Yii::t('app', 'Данный ИИН уже зарегистрирован')],
            ...
            [['name', 'surname', 'iin', 'grade', 'teacher_name', 'parent_name', 'teacher_type_name', 'phone', 'lang', 'region_id', 'city_id', 'school_id'], 'required'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'parent_name' => Yii::t('app', 'Ф.И.О родителя'),
            'parent_name_second' => Yii::t('app', 'Ф.И.О родителя (2)'),
